...
import DarkSwitch from '../components/neu/darkSwitch';

import NeuButton from '../components/neu/buttonText';
import NeuDialog from '../components/neu/dialog';


export default function Neumorphic(props) {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <Box sx={{py:'9vh', px:'20px', overflow:'auto'}}>
