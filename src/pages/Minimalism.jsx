...
import DarkSwitch from '../components/min/darkSwitch';

import NeuButton from '../components/min/buttonText';
import NeuDialog from '../components/min/dialog';

const CustContainer = styled(Container)(({ theme }) => ({
  background:theme.palette.secondary.main,
}));

const CustContainerInner = styled(Container)(({ theme }) => ({
  background:theme.palette.primary.main,
  padding:0,
  margin:0,
}));

export default function Minimalism(props) {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <CustContainerInner
          //maxWidth="100%" 
          sx={{height:'100%', width:'100%', px:'25px',pt:'3vh'}}
        >
          <Grid 
            container
