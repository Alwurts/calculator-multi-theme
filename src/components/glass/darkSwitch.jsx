...
const NeuSwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.neuShadow1.primary, // track color when active
      },
    },
  },
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.neuShadow1.secondary, // Color of thumb in any case
    width: 32,
    height: 32,
  ...
  '& .MuiSwitch-track': {
    opacity: 1,
    backgroundColor: theme.palette.neuShadow1.primary, //Track color when not active
    borderRadius: 30,
